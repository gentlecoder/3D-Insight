...
.skin-3 .main-container:before {
  background: #FFF;
  background: -moz-linear-gradient(to bottom, #eef5fa 0%, #ffffff 8%) 0 4px;
  background: -webkit-gradient(linear, 0 0, 0 100%, from(#eef5fa), color-stop(4%, #ffffff)) 0 4px;
  background: -webkit-linear-gradient(to bottom, #eef5fa 0%, #ffffff 8%) 0 4px;
  background: -o-linear-gradient(to bottom, #eef5fa 0%, #ffffff 8%) 0 4px;
  background: -ms-linear-gradient(to bottom, #eef5fa 0%, #ffffff 8%) 0 4px;
  background: linear-gradient(to bottom, #eef5fa 0%, #ffffff 8%) 0 4px;
